...
public class ClienteControllerTest {
	...
	public static HoverflyRule hoverflyRule = HoverflyRule
			.inSimulationMode(dsl(
					service("servicio-de-cuentas:9020").andDelay(10, TimeUnit.MILLISECONDS).forAll()
//							.andDelay(200, TimeUnit.MILLISECONDS).forAll()
							...
							"application/json")),
					service("servicio-de-cuentas:9021").andDelay(10, TimeUnit.MILLISECONDS).forAll()
//							.andDelay(10000, TimeUnit.MILLISECONDS).forAll()
							.get(startsWith("/cliente/"))
							.willReturn(success("[{\"id\":\"3\",\"numeroCuenta\":\"1234567892\",\"balance\":10000}]",
									"application/json")),
					service("servicio-de-cuentas:9022").andDelay(1000, TimeUnit.MILLISECONDS).forAll()
//							.andDelay(50, TimeUnit.MILLISECONDS).forAll()
	...
	public void testClientesConCuentas() {
		int a = 0, b = 0, d = 0;
		Cliente c2 = template.getForObject("/conCuentas/{id}", Cliente.class, 1);
		LOGGER.info("c2:" + c2);
